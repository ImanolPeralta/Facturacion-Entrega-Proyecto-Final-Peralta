...
--
-- Dumping data for table `detalle de la venta`
--

LOCK TABLES `detalle de la venta` WRITE;
/*!40000 ALTER TABLE `detalle de la venta` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle de la venta` ENABLE KEYS */;
UNLOCK TABLES;
